...
from source.schema.api_schema import SimpleLLMRequest, gpt4all_mistral_template
...
async def generate_llm_sync(request_data: SimpleLLMRequest,
    ...
    return await llm_service.generate_answer(prompt=request_data.prompt, model_type=request_data.llm_type)
